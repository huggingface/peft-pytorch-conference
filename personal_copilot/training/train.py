...
def get_args():
    ...
    parser.add_argument("--model_path", type=str, default="codellama/CodeLlama-13b-Instruct-hf")
    parser.add_argument("--dataset_name", type=str, default="smangrul/hf-stack-v2")
